        ...
        <div className="terms-category-radio">
            ...
            <div className="radio-group">
                <div className="radio-item">
                    <input type="radio" name="category" value="환불" onChange={handleSelect} />
                    <span>환불 및 해지 조항</span>
                </div>
                <div className="radio-item">
                    <input type="radio" name="category" value="자동결제" onChange={handleSelect} />
                    <span>자동결제 / 정기구독 조항</span>
                </div>
                <div className="radio-item">
                    <input type="radio" name="category" value="개인정보" onChange={handleSelect} />
                ...
                <div className="radio-item">
                    <input type="radio" name="category" value="광고" onChange={handleSelect} />
